...
type RoleServiceClient interface {
	// 查询角色列表
	ListRole(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListRoleResponse, error)
	// 查询角色详情
...
func (c *roleServiceClient) ListRole(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListRoleResponse, error) {
...
func (c *roleServiceClient) GetRole(ctx context.Context, in *v11.GetRoleRequest, opts ...grpc.CallOption) (*v11.Role, error) {
	out := new(v11.Role)
...
func (c *roleServiceClient) DeleteRole(ctx context.Context, in *v11.DeleteRoleRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (UnimplementedRoleServiceServer) ListRole(context.Context, *v1.PagingRequest) (*v11.ListRoleResponse, error) {
...
func _RoleService_GetRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).GetRole(ctx, req.(*v11.GetRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RoleService_CreateRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).CreateRole(ctx, req.(*v11.CreateRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RoleService_UpdateRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).UpdateRole(ctx, req.(*v11.UpdateRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RoleService_DeleteRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).DeleteRole(ctx, req.(*v11.DeleteRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
