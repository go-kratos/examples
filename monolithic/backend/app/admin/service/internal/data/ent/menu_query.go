...
func (mq *MenuQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (mq *MenuQuery) FirstIDX(ctx context.Context) int32 {
...
func (mq *MenuQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (mq *MenuQuery) OnlyIDX(ctx context.Context) int32 {
...
func (mq *MenuQuery) IDs(ctx context.Context) (ids []int32, err error) {
...
func (mq *MenuQuery) IDsX(ctx context.Context) []int32 {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
