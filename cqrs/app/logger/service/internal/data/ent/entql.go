...
func (sq *SensorQuery) Filter() *SensorFilter {
	return &SensorFilter{config: sq.config, predicateAdder: sq}
}
...
func (m *SensorMutation) Filter() *SensorFilter {
	return &SensorFilter{config: m.config, predicateAdder: m}
}
...
func (sdq *SensorDataQuery) Filter() *SensorDataFilter {
	return &SensorDataFilter{config: sdq.config, predicateAdder: sdq}
}
...
func (m *SensorDataMutation) Filter() *SensorDataFilter {
	return &SensorDataFilter{config: m.config, predicateAdder: m}
}
