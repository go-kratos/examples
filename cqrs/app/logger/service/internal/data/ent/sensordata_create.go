...
func (u *SensorDataUpsert) AddTime(v int64) *SensorDataUpsert {
	u.Add(sensordata.FieldTime, v)
	return u
}
...
// AddTime adds v to the "time" field.
func (u *SensorDataUpsertOne) AddTime(v int64) *SensorDataUpsertOne {
	return u.Update(func(s *SensorDataUpsert) {
		s.AddTime(v)
	})
}
...
// AddTime adds v to the "time" field.
func (u *SensorDataUpsertBulk) AddTime(v int64) *SensorDataUpsertBulk {
	return u.Update(func(s *SensorDataUpsert) {
		s.AddTime(v)
	})
}
