...
func (sdu *SensorDataUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *SensorDataUpdate {
...
func (sdu *SensorDataUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := sdu.mutation.Time(); ok {
		_spec.SetField(sensordata.FieldTime, field.TypeInt64, value)
	}
	if value, ok := sdu.mutation.AddedTime(); ok {
		_spec.AddField(sensordata.FieldTime, field.TypeInt64, value)
	}
	if sdu.mutation.TimeCleared() {
		_spec.ClearField(sensordata.FieldTime, field.TypeInt64)
	}
	if value, ok := sdu.mutation.SensorID(); ok {
		_spec.SetField(sensordata.FieldSensorID, field.TypeInt, value)
	}
	if value, ok := sdu.mutation.AddedSensorID(); ok {
		_spec.AddField(sensordata.FieldSensorID, field.TypeInt, value)
	}
	if value, ok := sdu.mutation.Temperature(); ok {
		_spec.SetField(sensordata.FieldTemperature, field.TypeFloat64, value)
	}
	if value, ok := sdu.mutation.AddedTemperature(); ok {
		_spec.AddField(sensordata.FieldTemperature, field.TypeFloat64, value)
	}
	if value, ok := sdu.mutation.CPU(); ok {
		_spec.SetField(sensordata.FieldCPU, field.TypeFloat64, value)
	}
	if value, ok := sdu.mutation.AddedCPU(); ok {
		_spec.AddField(sensordata.FieldCPU, field.TypeFloat64, value)
	}
...
func (sduo *SensorDataUpdateOne) Save(ctx context.Context) (*SensorData, error) {
	...
	if len(sduo.hooks) == 0 {
		...
		nv, ok := v.(*SensorData)
		if !ok {
			return nil, fmt.Errorf("unexpected node type %T returned from SensorDataMutation", v)
		}
		node = nv
	}
	return node, err
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (sduo *SensorDataUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *SensorDataUpdateOne {
