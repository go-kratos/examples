...
type Data_Database struct {
	...
	MaxIdleConnections    int32                `protobuf:"varint,4,opt,name=max_idle_connections,json=maxIdleConnections,proto3" json:"max_idle_connections,omitempty"`         // 连接池最大空闲连接数
	MaxOpenConnections    int32                `protobuf:"varint,5,opt,name=max_open_connections,json=maxOpenConnections,proto3" json:"max_open_connections,omitempty"`         // 连接池最大打开连接数
	ConnectionMaxLifetime *durationpb.Duration `protobuf:"bytes,6,opt,name=connection_max_lifetime,json=connectionMaxLifetime,proto3" json:"connection_max_lifetime,omitempty"` // 连接可重用的最大时间长度
}
...
var file_common_conf_data_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x05, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x36,
	...
	0x72, 0x65, 0x64, 0x69, 0x73, 0x1a, 0x8b, 0x02, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61,
	...
	0x63, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x07, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x65, 0x12, 0x30, 0x0a, 0x14,
	...
	0x61, 0x78, 0x5f, 0x6c, 0x69, 0x66, 0x65, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	...
	0x6f, 0x75, 0x74, 0x42, 0x30, 0x5a, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2d, 0x65, 0x6e,
...
var file_common_conf_data_proto_depIdxs = []int32{
	...
	3, // 2: common.conf.Data.Database.connection_max_lifetime:type_name -> google.protobuf.Duration
	3, // 3: common.conf.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	3, // 4: common.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	3, // 5: common.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
